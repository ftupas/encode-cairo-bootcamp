...
from homework_9.contracts.erc721.IERC721 import IERC721

@external
func __setup__() {
    // Deploy contract erc721
    %{
        context.contract_address  = deploy_contract("./homework_9/contracts/erc721/erc721.cairo", [
